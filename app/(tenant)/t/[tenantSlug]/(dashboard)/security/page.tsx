...
/**
 * Phase 4c: security centre, scoped to login_events + sessions (docs/05-
 * authentication-security.md) -- working-hours restriction, geo-fencing/
 * temporary-access, download security, and the full audit_logs coverage
 * pass are separate, later Phase 4 increments. Always reachable (every
 * signed-in user manages their own sessions); the tenant-wide activity
 * section only renders for security.manage holders, matching RLS's own
 * self-or-security.manage visibility on both tables.
 */
